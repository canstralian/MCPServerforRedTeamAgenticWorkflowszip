...
(function (WorkflowStage) {
    ...
    WorkflowStage["RECONNAISSANCE"] = "reconnaissance";
    WorkflowStage["EXPLOITATION"] = "exploitation";
    WorkflowStage["POST_EXPLOITATION"] = "post_exploitation";
...
function addStageToTools(tools) {
...
export function getToolsByStage(stage) {
    return toolsByStage[stage];
}
export function getAllToolsOrganized() {
    return toolsByStage;
}
