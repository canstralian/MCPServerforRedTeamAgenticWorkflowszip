...
export function handleIntegrationTool(name, args) {
    switch (name) {
        ...
        case 'hackerone_list_reports': {
            ...
            if (severity)
                endpoint += `&filter[severity][]=${severity}`;
            if (sort)
                endpoint += `&sort=${sort}`;
            return {
                content: [{
        ...
        case 'hackerone_create_report': {
            ...
            const vulnInfo = args.vulnerability_information;
            const impact = args.impact;
            const severity = args.severity_rating;
        ...
        case 'hackerone_update_report_state': {
            ...
            const closeReason = args.close_reason;
            return {
                content: [{
                        type: 'text',
                        text: JSON.stringify({
        ...
        case 'hackerone_add_comment': {
            const reportId = args.report_id;
            const commentMessage = args.message;
        ...
        case 'hackerone_update_severity': {
            ...
            const cvssVector = args.cvss_vector;
            return {
                content: [{
                        type: 'text',
                        text: JSON.stringify({
        ...
        case 'hackerone_award_bounty': {
            ...
            const bonusAmount = args.bonus_amount;
            const bountyMessage = args.message;
            return {
                content: [{
                        type: 'text',
                        text: JSON.stringify({
